# Generated by Django 2.1.2 on 2019-02-19 04:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.BooleanField(verbose_name='Patient Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('SQL_username', models.CharField(max_length=128)),
                ('SQL_password', models.CharField(max_length=128)),
                ('role', models.CharField(default='regular', max_length=128)),
                ('research_status', models.BooleanField(default=False)),
                ('last_search', models.CharField(default='', max_length=256)),
